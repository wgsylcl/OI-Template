...
对于前一半$k < n$，代入$\omega_n^k$，有$f(\omega_n^k) = F_1(\omega_n^{2k}) + \omega_n^{k}F_2(\omega_n^{2k}) = F_1(\omega_{\frac{n}{2}}^{k}) + \omega_n^{k}F_2(\omega_{\frac{n}{2}}^{k})$

利用性质求另一半，代入$\omega_n^{k+\frac{n}{2}}$，有$f(\omega_n^{k+\frac{n}{2}}) = F_1(\omega_n^{2k+n}) + \omega_n^{k+\frac{n}{2}}F_2(\omega_n^{2k+n}) = F_1(\omega_n^{2k}) - \omega_n^kF_2(\omega_n^{2k}) = F_1(\omega_{\frac{n}{2}}^k) - \omega_n^kF_2(\omega_{\frac{n}{2}}^k)$
...
$$R[x] = \frac{R[\frac{x}{2}]}{2} + [x \ \text{and} \ 1] \times \frac{n}{2}$$
...
$$z_k=\sum_{i = 0}^{n - 1}y_i(g_n^{-k})^i=\sum_{i = 0}^{n - 1}\sum_{j = 0}^{n - 1}a_j(g_n^i)^j(g_n^{-k})^i=\sum_{j = 0}^{n - 1}a_j\sum_{i = 0}^{n - 1}(g_n^{j - k})^i$$
